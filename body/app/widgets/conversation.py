...
class ConversationWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.notification.setObjectName(
            "conversationNotification"
        )

        self.notification.setAlignment(
            Qt.AlignmentFlag.AlignCenter
        )

        self.notification.setVisible(
            False
        )
        ...
        if self.theme == "light":
            ...
            self.setStyleSheet(
                ...
                QLineEdit#conversationSearchInput {
                    ...
                    padding: 6px 10px;
                    font-size: 11px;
                    selection-background-color: #9DDEEC;
    ...
    def _add_message(
        ...
        from body.app.widgets.chat_bubble import (
            ChatBubble
        )
    ...
    def _scroll_to_bottom_after_layout(
        self
    ):
